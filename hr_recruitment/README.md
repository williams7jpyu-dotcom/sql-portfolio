...
| テーブル | 主な役割 | 行数 |
|---------|---------|------|
| candidates | 候補者マスタ（氏名・経験年数・現職） | 4 |
| jobs | 求人マスタ（職種・部署・雇用形態・募集人数） | 3 |
| sources | 媒体マスタ（求人サイト・リファラル等） | 3 |
| applications | 応募トランザクション（応募日・ステータス・採用日） | 4 |
| application_stages | 選考ステージ履歴（各ステージの入退出日・結果） | 12 |
